...
class Store:
    ...
    def channel_names(self) -> tuple[str, ...]:
        ...
        질문에 적힌 채널명을 실제 이름으로 되돌리는 데 쓴다. 대규모 컬렉션에서는
    ...
    def list_subfolders_in_root(self, root: str) -> list[dict]:
        ...
        구조 자체"가 답이다 — `[Workspace]/논문` 아래 1단계 폴더(예: "paper-project(published
        ...
        # 집계됐다, 검토 과정에서 확인). file_id 집합으로 중복 제거해야 한다.
    ...
    def chunks_of_file(self, file_id: str, limit: int = 200) -> list[Hit]:
        ...
        중간·끝 청크가 조용히 누락될 수 있다. offset 으로
